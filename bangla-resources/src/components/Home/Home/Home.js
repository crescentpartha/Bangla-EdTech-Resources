        ...
        <div>
            <div className='text-start p-5'>
                <Row xs={1} md={2} className="g-4 mx-5 d-flex align-items-center justify-content-between">
                    <Col>
                        <h2 className='pb-2'>কোডিং শিখুন বিনামুল্যে</h2>
                        ...
                        <h4 className='pb-2'>সর্বশেষ টিউটোরিয়াল এবং আপডেট পেতেঃ</h4>
                        <div className='d-flex justify-content-start'>
                            ...
                            <button className='text-light p-2 btn btn-success rounded-end rounded-0'>সাবস্ক্রাইব!</button>
                        </div>
                    </Col>
