    ...
    return (
        <div className='border-bottom' style={{ height: '100vh', overflow: 'auto' }}>
            <div className='text-start p-4'>
                ...
                <div>
                    <CommentInput tutorial="python" topic="arrays"></CommentInput>
                </div>
                <div>
                    <CommentDisplay tutorial="python" topic="arrays"></CommentDisplay>
                </div>
            </div>
        </div>
    );
