            ...
            <div className='text-start p-4'>
                ...
                <div>
                    <div>
                        ...
                        <p>লিস্ট হল পাইথনে 4টি অন্তর্নির্মিত ডেটা টাইপ্স এর মধ্যে একটি যা ডেটা সংগ্রহের জন্য ব্যবহৃত হয়, অন্য 3টি হল <mark>Tuple</mark>, <mark>Set</mark> এবং <mark>Dictionary</mark>, যার সবগুলিরই বিভিন্ন গুণাবলী এবং ব্যবহার আছে।</p>
                        <p>বর্গাকার বন্ধনী ব্যবহার করে লিস্ট তৈরি করা হয়।</p>
                        ...
                        <div className='clipboard'>
                            <h4>উদাহরণঃ</h4>
                            <p>লিস্ট আইটেমের সংখ্যা প্রিন্ট করবে।</p>
                        ...
                        <p>পাইথনের দৃষ্টিকোণ থেকে, লিস্টগুলিকে ডেটা টাইপ <mark>'list'</mark> সহ অবজেক্ট হিসাবে সংজ্ঞায়িত করা হয়।</p>
                        <div className='clipboard'>
                            <h4>উদাহরণঃ</h4>
                            <p>একটি লিস্টের ডাটা টাইপ কি?</p>
